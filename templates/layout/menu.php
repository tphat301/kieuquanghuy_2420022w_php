    ...
    <div class="menu">
        <div class="wrap-content">
            <ul class="d-flex align-items-center justify-content-center">
                ...
                <li class="line"></li>
                <li>
                    <a class=" <?php if ($com == 'san-pham') echo 'active'; ?> transition" href="san-pham" title="<?= menu ?>"><?= menu ?></a>
                    <?php if (count($splist)) { ?>
                        <ul class="sub-menu">
                ...
                <li class="line"></li>
                <li><a class="<?php if ($com == 'thu-vien-anh') echo 'active'; ?> transition" href="thu-vien-anh" title="<?= album ?>"><?= album ?></a></li>
                <li class="line"></li>
                <li>
